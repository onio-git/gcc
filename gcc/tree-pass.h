...
extern gimple_opt_pass *make_pass_preunroll (gcc::context *ctxt);
...
extern rtl_opt_pass *make_pass_loop_spill_motion (gcc::context *ctxt);
...
extern rtl_opt_pass *make_pass_sink_liveout_copies (gcc::context *ctxt);
extern rtl_opt_pass *make_pass_reorder_blocks (gcc::context *ctxt);
extern void apply_branch_layout_profile (void);
